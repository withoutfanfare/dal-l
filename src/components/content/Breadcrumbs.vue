...
const segments = computed(() => {
  ...
  const documentCollection = findCollectionById(collections.value, props.document.collection_id)
...
<template>
  <nav aria-label="Breadcrumb" class="flex items-center gap-1.5 text-xs text-text-secondary">
